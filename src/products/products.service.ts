...
export class ProductsService {
  ...
  constructor(
    @InjectModel(Tile.name, 'productsDb') private tileModel: Model<Tile>,
    @InjectModel(Countertop.name, 'productsDb') private countertopModel: Model<Countertop>,
    @InjectModel(Cabinet.name, 'productsDb') private cabinetModel: Model<Cabinet>,
    @InjectModel(TopProduct.name, 'productsDb') private topProductModel: Model<TopProduct>,
    @InjectModel(Carpet.name, 'productsDb') private carpetModel: Model<Carpet>,
  ...
  async findCanadianProducts(): Promise<Tile[]> {
